...
.title[
# Clase 8. LATE y variables instrumentales
]
.subtitle[
...
t <- asignacion %>%
  kbl(align = "lccc",
      ...
      full_width = FALSE) %>%
  kable_paper(c("hover", "condensed", "responsive")) %>%
        add_header_above(c(" ", "Traamiento recibido:"=2, " "),
                   bold = TRUE,
                   background = "white") %>% 
...
- El martes habrá dos presentaciones que emplean la asignación experimental de dos programas
