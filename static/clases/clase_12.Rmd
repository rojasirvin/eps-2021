...
.title[
# Clase 12. Diferencia en diferencias
]
.subtitle[
...
$$m_T=\frac{Y_{6,post}-Y_{6,pre}}{X_{6,post}-X_{6,pre}}=\frac{Y_{8,post}-135}{1931-1930}=-33$$
- Por tanto, $Y_{8,post}=102$ es el número de bancos que el distrito 6 hubiera tendio si hubiera seguido una tendencia paralela a la del distrito 8 ]
