...
- Por teoría asintótica podemos saber que nuestro parámetro de interés tiene una distribución $\mathcal{N}(\hat{\theta}, \hat{V}(\theta))$
...
- Obtenemos una colección de tamaño $M$ de $\tilde{\theta}$, obtenidas de la distribución $\mathcal{N}(\hat{\theta}, \hat{V}(\theta))$


- Usando la colección de $M$ $\tilde{\theta}$s, podemos simular *bases de datos*
